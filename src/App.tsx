          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            ...
            <button
              ...
              style={{
                ...
                justifyContent: 'center',
                cursor: 'pointer',
                color: activeApp === 'calendar' ? '#a855f7' : (isLight ? '#4f46e5' : '#818cf8'),
                transition: 'all 0.15s ease-in-out',
                padding: 0,
              }}
              title={activeApp === 'checklist' ? "Switch to FX Economic Calendar" : "Switch back to Checklist"}
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = 'scale(1.1)';
              }}
              onMouseLeave={(e) => {
            ...
            >
              <svg viewBox="0 0 24 24" width="9" height="9" stroke="currentColor" strokeWidth="3.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path d="M18.36 6.64a9 9 0 1 1-12.73 0"></path>
                <line x1="12" y1="2" x2="12" y2="12"></line>
              </svg>
            </button>
